<?php 
include "../../connect.php";
$sql = mysqli_query($koneksi, "SELECT * FROM kd_pengetahuan WHERE id_kd = '".$_GET['id']."'");
        ...
        <div class="col-xs-12 ol-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a type="submit" class="btn btn-primary m-t-15 waves-effect" href="delete/delete_ki3.php?id=<?= $sqlkd['id_kd']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus KD ini?')">DELETE</a>
                                                <a type="button" class="btn btn-primary m-t-15 waves-effectt" href="?page=ki3">CENCEL</a>
                                            </div>
                                        </form>
...
if (isset($_POST['submit'])) {
    ...
    $sqlkd = mysqli_query($koneksi, "UPDATE kd_pengetahuan SET id_kd = '".$idkd."', nom = '".$nom."', nomor_kd ='".$nomor_kd."', deskripsi ='".$deskripsi."', id_mapel = '".$idmapel."', id_kelas = '".$id_kelas."', id_semester = '".$id_semester."' WHERE id_kd = '".$idkd."' ");
    if ($sqlkd) {
        echo "<script>
        alert('Data berhasil diupdate');
        document.location.href = '?page=ki3';
        </script>";
    }else{
        echo "<script>
