<?php 
$sql = mysqli_query($koneksi, "SELECT * FROM nilai_agamakd_ki3 WHERE id_mapel = '".$_GET['id']."' AND id_kd = '".$_GET['edit']."' AND id_siswa = '".$_GET['sis']."'");
