<nav aria-label="breadcrumb m-0">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="javascript:void(0);" class="menu-toggle">Input keterampilan</a></li>
    <li class="breadcrumb-item active" aria-current="page"><i><b>KI-4 mapel</b></i></li>
  </ol>
</nav>
<!-- Basic Examples -->
                <?php 
                ...
                ?>
                    ...
                    <div class="card">
                        <div class="header bg-indigo">
                            <h5>
                                <?= $data_mapel['id_mapel']." - ".$data_mapel['nama_mapel']; ?> KOMPETENSI INTI (KI-4)
                                <small>Nilai KI-4.</small>
                            </h5>
                        ...
                        <div class="body">
                                        ...
                                        <table id="mainTable" class="table table-sm table-striped table-hover dataTable js-exportable font-11">
                                            ...
                                            <?php 
                                            //stop loop
                                            $stop_loop = mysqli_query($koneksi, "SELECT * FROM kd_keterampilan WHERE id_kelas = '".$dtsq1['id_kelas']."' AND id_semester = '".$dtsq2['id_semester']."' ORDER BY id_kd");
                                            while ($kd_ktm = mysqli_fetch_array($stop_loop)) {
                                                if (($data_mapel['id_mapel'] === $kd_ktm['id_mapel'])) {
                                            ?>
                                            <tbody>
                                                <tr>
                                                    <td><?= $kd_ktm['nom']; ?></td>
                                                    <td><?= $kd_ktm['nomor_kd']; ?></td>
                                                    <td><?= $kd_ktm['deskripsi']; ?></td>
                                                    <td><a type="button" class="btn bg-indigo m-t-0 waves-effect" href="?page=edit_ki4&id=<?= $kd_ktm['id_kd']; ?>">Detail</a></td>
                                                </tr>
                                            </tbody>
                                            <?php }
                                            }
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="defaultModalLabel">INPUT KD KI-4 KETERAMPILAN</h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="row clearfix">
                                <div class="col-xs-12 ol-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <form id="form_validation" method="POST" action="proses/proses_kd_ki4.php">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="id_kd_keterampilan" value="<?= $ktm; ?>" required readonly>
