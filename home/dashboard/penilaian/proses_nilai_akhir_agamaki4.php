...
$ki3 = mysqli_query($koneksi, "SELECT max(id_nilairaport) AS maxCode FROM nilai_raport_ki4");
...
$sql = mysqli_query($koneksi, "SELECT * FROM nilai_raport_ki4 WHERE id_siswa = '".$id_siswa."' AND id_mapel = '".$id_mapel."' AND id_kelas = '".$id_kelas."' AND id_semester = '".$id_semester."'");
