<?php 
$sql = mysqli_query($koneksi, "SELECT* FROM nilai_akhir_raportkd_ki3 WHERE id_mapel = '".$_GET['id']."' AND id_kd = '".$_GET['kd']."' AND id_siswa = '".$_GET['sis']."'");
$dat = mysqli_fetch_array($sql);

//ambil data maximal di kolom id_raportkd table nilai_raportkd_ki3
$queryku = mysqli_query($koneksi, "SELECT max(id_raportkd) AS maxCode FROM nilai_raportkd_ki3");
...
<div class="card">
	...
	<div class="body">
		<form action="" method="POST">
            ...
            <div class="col-lg-6 col-md-4 col-sm-4 col-xs-4 bg-cyan">
                <div class="form-group form-float">
                    <div class="form-line">
...
$sqli = mysqli_query($koneksi, "SELECT * FROM nilai_raportkd_ki3 WHERE id_siswa = '".$id_siswa."' AND id_mapel = '".$id_mapel."' AND id_kd = '".$id_kd."'");
$cek = mysqli_num_rows($sqli);
    if ($cek == 1) {
        echo "<script>
        alert('Data sudah ada');
        document.location.href = '?page=nilai_akhir_raportki3&id=$id_mapel&sis=$id_siswa';
        </script>";
    }else{

     $isi = mysqli_query($koneksi, "INSERT INTO nilai_raportkd_ki3(id_raportkd, id_siswa, id_mapel, id_kelas, id_semester, nama_mapel, id_kd, nomor_kd, deskripsi, tugas1, tugas2, tugas3, tugas4, tugas5, ph1, ph2, ph3, ph4, pts, pas) VALUES('".$id_raportkd."','".$id_siswa."','".$id_mapel."', '".$id_kelas."', '".$id_semester."','".$nama_mapel."','".$id_kd."','".$nomor_kd."','".$deskripsi."','".$tugas1."','".$tugas2."','".$tugas3."','".$tugas4."','".$tugas5."','".$ph1."','".$ph2."','".$ph3."','".$ph4."','".$pts."','".$pas."')");
     if ($isi) {
        echo "<script>
