...
while ($data = mysqli_fetch_array($sql)) {
	$array[] = array('singkatk4' => $data['singkat_mapel']
	);
}

$jml_data = mysqli_query($koneksi, "SELECT x.id_siswa, nama_siswa, SUM(nilai) AS jumlah, COUNT(id_mapel) AS total_mapel, ROUND(SUM(nilai)/COUNT(id_mapel)) AS rata_rata FROM nilai_raport_ki4 X INNER JOIN data_siswa Y ON y.id_siswa = x.id_siswa where id_kelas = '".$dtsq1['id_kelas']."' AND id_semester = '".$dtsq2['id_semester']."' GROUP BY x.id_siswa ASC");
...
<nav aria-label="breadcrumb m-0">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="javascript:void(0);" class="menu-toggle">KD Keterampialn</a></li>
    <li class="breadcrumb-item active" aria-current="page"><i><b>Rekap Nilai KI-4</b></i></li>
  </ol>
</nav>
<div class="card">
	<div class="header bg-indigo">
		<h2>Rekap Nilai KI-4 (Keterampilan)</h2>
	</div>
	<div class="body">
		<!-- Membuat card -->
		<div class="body">
