	...
	<div class="container-fluid">
		<div class="card m-t-100">
			<div class="header bg-light-blue">
				<h2>Edit Ekstrakurikuler : <?= $siswa['nama_siswa']; ?></h2>
			</div>
        <div class="body">
				<form method="POST" action="../edit_ekskul/proses_edit_ekskul.php">
                    <!-- ini intuk id siswa -->
                    ...
                    <div class="">
                        <table class="table table-bordered">
                            <thead>
                                ...
                                <tr>
                                    <th class="col-xs-2">Muatan 1</th>
                                    <th class="col-xs-2">Muatan 2</th>
                                    <th class="col-xs-2">Muatan 3</th>
                                </tr>
                            </thead>
                            <tbody>   
                            <?php include "../edit_ekskul/milik_tr.php"; ?>
                            <tr hidden>
                              <?php 
