...
$sql_kd = mysqli_query($koneksi, "SELECT * FROM kd_keterampilan WHERE id_mapel = '".$_GET['id']."' AND id_kelas = '".$dtsq1['id_kelas']."' AND id_semester = '".$dtsq2['id_semester']."'");
...
$sql_kkm = mysqli_query($koneksi, "SELECT id_mapel, nama_mapel, keterampilan, 
...
<div class="card">
	<div class="header bg-indigo">
		<h2>INPUT NILAI KD KETERAMPILAN <?= $data_kkm['id_mapel'];  ?> | <?= $dt_siswa['nama_siswa']; ?></h2>
	</div>
	<div class="body">
...
if (isset($_POST['tampil'])) {
	...
	?>
<form action="penilaian/proses_nilai_akhirki4.php" method="POST">
		...
		<table class="table table-hover table-bordered">
			...
			<tbody>
				<tr>
					...
					<td><?= round($nilai); ?>
						<div hidden><input type="text" name="nilai" value="<?= round($nilai); ?>"></div>
					</td>
					<td><?= $predikat; ?>
