<?php 
$sql = mysqli_query($koneksi, "SELECT * FROM nilai_akhir_raportkd_ki3 WHERE id_mapel = '".$_GET['id']."' AND id_siswa = '".$_GET['sis']."'");
...
<div class="card">
	...
	<div class="body">
		...
		<table class="table table-responsive">
			...
			$query = mysqli_query($koneksi, "SELECT * FROM nilai_akhir_raportkd_ki3 
							...
							<td>
								<div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="?page=nilai_akhir_raportki3&id=<?= $data['id_mapel'] ?>&sis=<?= $data['id_siswa']; ?>&kd=<?= $kd['id_kd']; ?>">Nilai</a></li>
                                    </ul>
                                </div>
							</td>
						</tr>
		...
		<table class="table table-responsive table-bordered table-hover">
			<thead>
				<tr>
					...
					$nilai = array("Nomor kd","Tugas1","Tugas2","Tugas3","Tugas4","Tugas5","PH1","PH2","PH3","PH4","PTS","PAS","NILAI KD", "ACTION");
			...
			$sqlkd = mysqli_query($koneksi, "SELECT * FROM hitung_kd WHERE id_mapel = '".$data['id_mapel']."' AND id_siswa = '".$data['id_siswa']."' AND id_kelas = '".$dtsq1['id_kelas']."' AND id_semester = '".$dtsq2['id_semester']."'");
					...
					<tr class="font-12">
						...
						<td>
							<div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="?page=nilai_akhir_raportki3&id=<?= $data['id_mapel']; ?>&sis=<?= $data['id_siswa']; ?>&edit=<?= $kd['id_kd']; ?>">Edit</a></li>
                                    </ul>
                                </div>
						</td>
					</tr>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row clearfix">
                                <div class="col-xs-12 ol-sm-12 col-md-12 col-lg-12">
										<?php 
										$nilkd = mysqli_query($koneksi, "SELECT max(nilai_kd) as nilai FROM hitung_kd WHERE id_mapel = '".$data['id_mapel']."' AND id_siswa ='".$data['id_siswa']."' AND id_kelas = '".$dtsq1['id_kelas']."' AND id_semester = '".$dtsq2['id_semester']."'");
										$datakd = mysqli_fetch_array($nilkd);

										$sqlkkm = mysqli_query($koneksi, "SELECT Y.pengetahuan as pengetahuan, Y.id_mapel as id_mapel, id_kelas, id_semester FROM hitung_kd X INNER JOIN mapel Y WHERE Y.id_mapel ='".$data['id_mapel']."' AND id_siswa = '".$data['id_siswa']."' AND id_kelas = '".$dtsq1['id_kelas']."' AND id_semester = '".$dtsq2['id_semester']."'");
										...
										$e = $kkm - $rentang; //$rentang adalah 10
                                        ...
                                        <div class="form-group form-float">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <textarea name="deskripsi" cols="30" rows="5" class="form-control no-resize" required readonly><?php echo $sis . $sttm . "tuntas dengan predikat " . $stm . ", " . $sis ." ". $stm . " dalam "; kkm(); ?>
                                                    </textarea>
                                                </div>
                                            </div>
                                            <?php 
