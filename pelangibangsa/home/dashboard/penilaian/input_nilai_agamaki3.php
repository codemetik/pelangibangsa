...
$sql_kd = mysqli_query($koneksi, "SELECT * FROM kd_agama_ki3 WHERE id_mapel = '".$_GET['id']."' AND id_agama = '".$_GET['agm']."' AND id_kelas = '".$dtsq1['id_kelas']."' AND id_semester = '".$dtsq2['id_semester']."'");
...
//membuat query untuk menggabungkan data mapel dan data kad serta agama yg tersedia di aplikasi
$sql_agm = mysqli_query($koneksi, "SELECT id_mapel, nama_mapel, pengetahuan , 
...
if (isset($_POST['tampil'])) {
	...
	?>
<form action="penilaian/proses_nilai_akhir_agamaki3.php" method="POST">
