<?php 
$editkd = mysqli_query($koneksi, "SELECT * FROM kd_agama_ki3 WHERE id_kd = '".$_GET['editkd']."' GROUP BY id_agama");
            ...
            <div class="col-xs-12 ol-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="index.php?page=ki3_pabp" type="button" class="btn bg-indigo waves-effect" data-dismiss="modal">TUTUP</a>
                        </div>
                    </form>
...
$sqledit = mysqli_query($koneksi, "UPDATE kd_agama_ki3 SET id_kd = '".$id_kd."', nom = '".$nom."', nomor_kd = '".$nomor_kd."', deskripsi = '".$des."', id_mapel = '".$id_mapel."', id_agama = '".$id_agama."', id_kelas = '".$id_kelas."', id_semester = '".$id_semester."' WHERE id_kd = '".$id_kd."'");
if ($sqledit) {
        echo "<script>
        alert('Data berhasil di perbaharui');
        document.location.href = 'index.php?page=ki3_pabp';
        </script>";
    }else{
        echo "<script>
