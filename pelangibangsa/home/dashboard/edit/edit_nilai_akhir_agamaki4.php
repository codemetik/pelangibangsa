<?php 
$sql = mysqli_query($koneksi, "SELECT * FROM nilai_agamakd_ki4 WHERE id_mapel = '".$_GET['id']."' AND id_kd = '".$_GET['edit']."' AND id_siswa = '".$_GET['sis']."'");
$dat = mysqli_fetch_array($sql);

$ids = mysqli_query($koneksi, "SELECT id_agama FROM data_siswa WHERE id_siswa = '".$dat['id_siswa']."'");
$idagm = mysqli_fetch_array($ids);
$id_agama = $idagm['id_agama'];
?>
<div class="card">
