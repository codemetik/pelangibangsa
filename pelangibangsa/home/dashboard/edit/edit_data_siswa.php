...
include "../../connect.php";
$nama_siswa = $_GET['id'];
$sql = mysqli_query($koneksi, "SELECT * FROM data_siswa WHERE nama_siswa = '".$nama_siswa."'");
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12">
                                            ...
                                            <button class="btn bg-indigo waves-effect" type="submit" name="submit">SIMPAN PERUBAHAN</button>
                                        </form>
