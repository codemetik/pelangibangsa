<nav aria-label="breadcrumb m-0">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page"><i><b>KI-4 PABP</b></i></li>
  </ol>
</nav>
<div class="card">
		...
		<div class="row clearfix">
			<form action="" method="POST">
				...
				<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
					<input type="submit" name="get" class="btn bg-indigo" value="GET">
				</div>
			</form>
		</div>
	</div>
					...
					<div class="table">
						<table class="table table-bordered table-hover font-11">
							...
							<tbody>
								...
								$kd_agama = mysqli_query($koneksi, "SELECT * FROM kd_agama_ki4 WHERE id_agama = '".$data['id_agama']."' AND id_kelas = '".$dtsq1['id_kelas']."' AND id_semester = '".$dtsq2['id_semester']."'");
											...
											<td>
												<div class="dropdown font-12">
                                                    ...
                                                    <ul class="dropdown-menu pull-right">
                                                        <li><a href="index.php?page=ki4_pabp&editkd=<?= $kd['id_kd']; ?>" class="font-12">Edit <?= $kd['nomor_kd']; ?></a></li>
                                                        <li><a href="delete/delete_kd_agamaki4.php?id=<?= $kd['id_kd']; ?>" class="font-12" onclick="return confirm('Apakah anda yakin ingin menghapus KD ini?')">Delete</a></li>
                                                    </ul>
                                                </div>
											</td>
										</tr>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row clearfix">
                                <div class="col-xs-12 ol-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <form id="form_validation" method="POST" action="proses/proses_kd_agamaki4.php">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="id_kda" value="<?= $dkdki4; ?>" required readonly>
...
if (isset($_GET['editkd'])) {
	include "edit/edit_kd_agamaki4.php";
}
